...
/* For the 2nd index: 	index = 0, no special keys enabled
			...
			Keyboard scancodes adapted from table: http://www.ee.bgu.ac.il/~microlab/MicroLab/Labs/ScanCodes.htm
*/
char *scancodes[][NUMBER_OF_MODES] = {
	...
	{"5", "%", "5"}, 		{"6", "^", "6"}, 		{"7", "&", "7"}, 
	{"8", "*", "8"}, 		{"9", "(", "9"}, 		{"0", ")", "0"}, 
	{"-","_", "-"}, 		{"=", "+", "="}, 		{"BACKSPACE", "BACKSPACE", "BACKSPACE"}, 
	...
	{"SCROLL_LOCK", "SCROLL_LOCK", "SCROLL_LOCK"}, 			{"Keypad-7", "Keypad-7", "Keypad-7"}, 
